...
import "https://raw.githubusercontent.com/htan-pipelines/bulk-rna-seq-pipeline/master/TRUST.wdl" as TRUST_wdl
...
workflow rnaseq_pipeline_workflow {
    ...
    call TRUST_wdl.TRUST{
       input: 
       input_bam = star.bam_file, 
       ref_fasta = refFasta, 
       ref_fasta_IMGT = refFasta_IMGT, 
