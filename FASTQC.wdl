...
task FASTQC {
  ...
  runtime {
   ...
   output{
    File fastqc_1_html=${fwdfastq}_fastqc.html[0]
    File fastqc_1_zip=${fwdfastq}_fastqc.zip[0]
    File fastqc_2_html=${revfastq}_fastqc.html[0]
    File fastqc_2_zip=${revfastq}_fastqc.zip[0]
  }
}
